...
===Field Examples===
Over the past decade deep neural networks (DNNs), a type of machine learning (ML) algorithm, have enjoyed continued success, both in scientific contexts and real world deployment. Some has gone has far to claim it a “revolution in scientific research” (Royal Society and Alan Turing Institute, 2019, p. 1). Within research, they have been employed in multiple different scientific fields. For example, classifying anthrax spores (Jo et al., 2017), data reduction in high energy physics (Guest et al. 2018), earthquake prediction (Yang et al., 2022), and healthcare (Alowais et al., 2023; Gulshan et al., 2016; Donnelly, 2017; Longoni, Bonezzi and Morewedge 2019; McKinney et al., 2020; Topol, 2019). 

Outside of research, they have been used in contexts of criminal recidivism (CITE), banking (Aggarwal, 2021), and data gathering for policy making (Alikhademi et al., 2022). Despite this widespread use, DNNs \footnote{This paper focuses on DNNs instead of other ML algorithms because they present the most compelling epistemic challenges due to their architecture and "hidden layers". While our discussion will talk mostly about DNNs, there is no reason why any result cannot be extended to other types of supervised ML models. Unsupervised ML models are not in the scope of this paper.}

have faced allegations of being "black boxes" (Dobson). This is a common, if not colloquial, label for a tool for which it is not possible to understand the inner workings. Some researchers claim that the powerful predictive capacity of a DNN carries with it a greater level of "opaqueness"[[Prediction versus understanding in computationally enhanced neuroscience]] (Omri Barak (2017: p. 5)
