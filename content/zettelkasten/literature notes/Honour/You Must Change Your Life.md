...
1. The first section goes over how scientists are expected to trust scientific instruments and how these instruments could be "opaque"
	1. We then establish DNNs as a type of scientific instrument within the context of scientific discovery and why they are commonly considered opaque. Also why scientists have a problem with them 
	2. Therefore, these are the following problems with DNNs: 
		1. .
	3. There are many ways that we can attempt to solve this. 
		1. ExAI
		2. Problems with ExAI
	4. Pragmatic treatment of DNNs in the process of scientific discovery 

Structure 

Thesis: DNNs are epistemically opaque in a way different to other scientific instruments. How can we go about trusting their results? 

Introduction 
1. Prevalence of DNNs 
	1. [[Examples of AI in Scientific Discovery]]
	2. [[Examples of AI use in Science]]
...
1. What is a DNN 
	1. How are they already being used in scientific research. 
	2. They occupy a very similar role as other scientific instruments 
2. What is a scientific instrument 
	1. Given DNNs occupy a similar role to other scientific instruments, It is common to treat DNNs as scientific instruments [[Instruments, Agents, and Artificial Intelligence]] within the literature. 
	2. What are scientific instruments 
		1. Scientific instruments are generally treated as an intuitive object (Kletzl/Neges)
		2. "“Instruments” can be seen as a subclass of tools, namely those tools that are designed, manufactured and calibrated to fulfill specifically epistemic tasks and purposes." (Kletzl pg. 108)
			1. Scientific instruments follow from this in assisting with scientific discovery 
	3. How do we justify a scientific instrument? (Different from justifying the results of an instrument)
		1. Franklin Epistemology of the experiment. (1986, 2002, 2005) [[The Scientific Use of Technological Instruments]] pg. 64 - For justifying the results of an instrumetn 
	...
	4. Types of scientific instruments. 
		1. Distinction between mathematical and philosophical instruments
			1. "Philosophical instruments"
				1. "“Philosophical instruments” were used by the newly-emerging cast of “natural philosophers” in their experiments for acquiring “pure truths” about natures inner workings. Examples are telescopes, microscopes or the famous air pumps" (Kletzl pg. 110)
					1. "Examples of such instruments are compasses, quadrants and astrolabes and all kinds of measuring instruments" (see Warner 1990).
					2. Motivated at the time by social boundaries in the process of science. This way of delineating different types of instruments has no real plausible epistemic principle to act as a foundation. As we will see, certain instruments occupy can occupy both categories depending on the context of use. (van Helden 1983, 65)
		2. Most other categorisations of instruments differentiate on similar lines. 
			1. Types of categorisation 
				1. Harre categorisation 
					1. Instrument - device for detecting and measuring natural phenomena
					2. Apparatus - study natural processes by simulating them
				2. Baird categorisation 
					1. Instruments that create phenomena and those who model it. 
				3. Heidelberger categorisation 
			...
			2. While these are all different ways of systematising instruments. We can say that there are two general categories 
				1. *instruments that interact with the world* 
					1. *instruments that interact with the world* intervene with the world in some way by exploiting a causal pathway. Hacking (1983 [[The Scientific Use of Technological Instruments]] pg. 62)
					2. "As has been indicated in the former section, a phenomenon is established through the entangled activities of materially producing it and forming a theoretical concept. Next, scientists aim to reproduce or manipulate the phenomenon through interventions with instruments and experimental set-ups, which enable investigation, but at the same time generate and shape the phenomenon"
						1. "Any test of theory is related to apparatus that has evolved in conjunction with it – and in conjunction with modes of data analysis."
					3. Therefore, an instrument evolves in the process of an experiment. All scientific instruments need to be viewed in the context of the experiment and the theory they are used within. 
				2. *instruments that model the world*
					1. They are analogous to the world in some way. They gain their reliability by 
		3. DNNs as being both types of instruments 
			1. The DNN depending on its context can be both types of instruments. Meaning it has to fulfil both criterion of justification. 
			...
			3. *instruments that model the world*
				...
				3. Large language models. The DNN stores statistical models of language use. It acts a model.

		4. What is the greater overall role of scientific instruments within the process of scientific discovery? 
			1. A scientific instrument is only valid in the presence of a theory 
				1. Evidence for this? 
				2. [[The Scientific Use of Technological Instruments]]
		5. What role does a scientific instrument play in the process of scientific discovery 
			1. It doesn't just measure things and return data. 
			2. Two general lines of thought 
				1. Theory Oriented 
...
3. Explanation of core terms 
	1. What does explain mean? 
	2. What is an epistemically relevant element? 
4. What is the problem with certain instruments? 
	1. Technical Opaqueness 
		1. Non-understanding of each moving part.
	2. Social Opaqueness
		1. Barriers to double checking 
5. How do social epistemologists deal with this?
	1. They argue for NTV
		1. Rundown of NTV 
...
2. It doesn't help in the greater role of scientific discovery by serving an explanatory role 
	...
	3. Therefore, we need to understand how certain inputs lead to specific outputs. 
3. Sum up the ways that a DNN is opaque 
